...
- v(negative 1) was even trashier lol, it didnt have even option to dm or broadcast and the  message was passed around in raw text . unlike not it is passed around as objects of a pydantic model .
